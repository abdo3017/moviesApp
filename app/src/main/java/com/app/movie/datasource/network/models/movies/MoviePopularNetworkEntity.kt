...
data class MoviePopularNetworkEntity(
    @SerializedName("page")
    val page: Int = 0,
...
fun List<MoviePopularResult>.asDomainModelList(): List<FavouriteMovie> {
    return map {
        FavouriteMovie(
            id = it.id,
            video = it.video,
...
fun MoviePopularResult.asDomainModel() = FavMoviePopularResult(id = id)
