...
class TVSeriesPopularFragment(private val items: Flow<PagingData<TVSeriesPopularResult>>) :
    BaseFragment<FragmentTVPopularBinding, Any>(),
    TVSeriesPopularAdapter.TVSeriesInteraction {

    private var lastSelectedItemBinding: ItemTVPopularBinding? = null
    private lateinit var layoutManager: CenterZoomLayoutManager
    private var adapter: TVSeriesPopularAdapter = TVSeriesPopularAdapter(this)
    ...
    private fun displayMovieDetails(binding: ItemTVPopularBinding, show: Boolean) {
        //Hide Image
